...
Baseline Capture
- Command: `python scripts/capture_txt2img_baselines.py --config .sangoi/docs/examples/txt2img_baselines.sample.json --output-dir tests/backend/fixtures/txt2img --overwrite`
