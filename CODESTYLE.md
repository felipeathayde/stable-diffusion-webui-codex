...
6. **Zero tolerance for shims / copy-paste**  
   ...
   - Never copy code from archived upstream snapshots or external sources verbatim; study the behaviour (baseline: Hugging Face Diffusers) and reimplement in Codex style.  
