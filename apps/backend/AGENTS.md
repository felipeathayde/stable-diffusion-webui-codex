...
- 2025-11-02: `CODEX_CALLTRACE` attaches a dedicated handler so entry/exit traces emit even with INFO-level global logging; duplicates on root handlers are suppressed.
