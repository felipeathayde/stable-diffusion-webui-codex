...
- 2026-01-04: LoRA/VAE/WAN22 GGUF discovery now reuses the shared inventory scanners (`apps/backend/inventory/scanners/*`) to keep `/api/models/inventory` and `/api/{loras,vaes}` aligned on roots/extension policy.
