...
- 2026-02-20: `generation.py` WAN video parsing now validates `gguf_sdpa_policy` strictly (`mem_efficient|flash|math`) and normalizes accepted values to lowercase before request dispatch.
