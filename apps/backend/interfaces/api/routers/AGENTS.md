...
- 2026-02-21: `generation.py` now validates/forwards optional `img2vid_chunk_buffer_mode` (`hybrid|ram|ram+hd`) and fails loud when provided without `img2vid_chunk_frames`.
