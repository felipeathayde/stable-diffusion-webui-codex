...
- 2026-01-29: `tools.py` `POST /api/tools/convert-gguf` supports `codexpack_v1=true` to additionally pack a CodexPack v1 `*.codexpack.gguf` sidecar after conversion (Z-Image Base only; requires `quantization=Q4_K` + Comfy Layout).
