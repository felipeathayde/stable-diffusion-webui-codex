...
FIELDS: list[FieldDef] = [
    ...
    FieldDef(key='codex_flux_core_streaming_enabled', label='Flux core streaming (experimental)', type=SettingType.CHECKBOX, section=SectionId.SDXL, default=False, min=None, max=None, step=None, choices=None, choices_source=None),
    FieldDef(key='codex_flux_core_streaming_policy', label='Flux core streaming policy', type=SettingType.DROPDOWN, section=SectionId.SDXL, default='naive', min=None, max=None, step=None, choices=['naive', 'window', 'aggressive'], choices_source=None),
    FieldDef(key='codex_flux_core_streaming_blocks_per_segment', label='Flux core streaming blocks per segment', type=SettingType.SLIDER, section=SectionId.SDXL, default=4, min=1, max=16, step=1, choices=None, choices_source=None),
    FieldDef(key='codex_flux_core_streaming_window_size', label='Flux core streaming window size', type=SettingType.SLIDER, section=SectionId.SDXL, default=2, min=1, max=16, step=1, choices=None, choices_source=None),
    FieldDef(key='codex_flux_core_streaming_auto_threshold_mb', label='Flux core streaming auto-enable below free VRAM (MB)', type=SettingType.NUMBER, section=SectionId.SDXL, default=0, min=0, max=65536, step=256, choices=None, choices_source=None),
    FieldDef(key='codex_engine', label='(Codex) Engine', type=SettingType.TEXT, section=SectionId.SYSTEM, default='sd15', min=None, max=None, step=None, choices=None, choices_source=None),
    FieldDef(key='codex_mode', label='(Codex) Mode', type=SettingType.TEXT, section=SectionId.SYSTEM, default='Normal', min=None, max=None, step=None, choices=None, choices_source=None),
    FieldDef(key='codex_attention_backend', label='(Codex) Attention backend', type=SettingType.DROPDOWN, section=SectionId.SYSTEM, default='torch-sdpa', min=None, max=None, step=None, choices=['torch-sdpa', 'xformers', 'sage'], choices_source=None),
    FieldDef(key='codex_diffusion_device', label='(Codex) Diffusion device', type=SettingType.DROPDOWN, section=SectionId.SYSTEM, default='auto', min=None, max=None, step=None, choices=['auto', 'cuda', 'cpu', 'mps', 'xpu', 'directml'], choices_source=None),
    FieldDef(key='codex_core_device', label='(Codex) Core device', type=SettingType.DROPDOWN, section=SectionId.SYSTEM, default='auto', min=None, max=None, step=None, choices=['auto', 'cuda', 'cpu', 'mps', 'xpu', 'directml'], choices_source=None),
    FieldDef(key='codex_te_device', label='(Codex) Text encoder device', type=SettingType.DROPDOWN, section=SectionId.SYSTEM, default='auto', min=None, max=None, step=None, choices=['auto', 'cuda', 'cpu', 'mps', 'xpu', 'directml'], choices_source=None),
    FieldDef(key='codex_vae_device', label='(Codex) VAE device', type=SettingType.DROPDOWN, section=SectionId.SYSTEM, default='auto', min=None, max=None, step=None, choices=['auto', 'cuda', 'cpu', 'mps', 'xpu', 'directml'], choices_source=None),
    FieldDef(key='codex_core_dtype', label='(Codex) Core dtype', type=SettingType.DROPDOWN, section=SectionId.SYSTEM, default='auto', min=None, max=None, step=None, choices=['auto', 'fp16', 'bf16', 'fp32'], choices_source=None),
    FieldDef(key='codex_te_dtype', label='(Codex) Text encoder dtype', type=SettingType.DROPDOWN, section=SectionId.SYSTEM, default='auto', min=None, max=None, step=None, choices=['auto', 'fp16', 'bf16', 'fp32'], choices_source=None),
    FieldDef(key='codex_vae_dtype', label='(Codex) VAE dtype', type=SettingType.DROPDOWN, section=SectionId.SYSTEM, default='auto', min=None, max=None, step=None, choices=['auto', 'fp16', 'bf16', 'fp32'], choices_source=None),
    ...
    FieldDef(key='codex_smart_cache', label='(Codex) Smart cache (SDXL conditioning cache)', type=SettingType.CHECKBOX, section=SectionId.SYSTEM, default=False, min=None, max=None, step=None, choices=None, choices_source=None),
