...
FIELDS: list[FieldDef] = [
    ...
    FieldDef(key='codex_smart_cache', label='Smart cache (TE/embeds)', type=SettingType.CHECKBOX, section=SectionId.OPTIMIZATIONS, default=False, min=None, max=None, step=None, choices=None, choices_source=None),
    FieldDef(key='codex_core_streaming', label='Core streaming (for large models)', type=SettingType.CHECKBOX, section=SectionId.OPTIMIZATIONS, default=False, min=None, max=None, step=None, choices=None, choices_source=None),
    FieldDef(key='codex_wan22_use_spec_runtime', label='WAN22: experimental nn runtime/spec for txt2vid/img2vid', type=SettingType.CHECKBOX, section=SectionId.OPTIMIZATIONS, default=False, min=None, max=None, step=None, choices=None, choices_source=None),
