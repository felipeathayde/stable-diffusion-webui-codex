...
FIELDS: list[FieldDef] = [
    ...
    FieldDef(key='codex_attention_backend', label='(Codex) Attention backend', type=SettingType.DROPDOWN, section=SectionId.SYSTEM, default='torch-sdpa', min=None, max=None, step=None, choices=['torch-sdpa', 'xformers'], choices_source=None),
