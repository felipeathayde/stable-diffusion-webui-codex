...
Defines the default roots and per-family overrides (paths.json keys, including Flux.2 and Anima) and yields LoRA weight files in stable order.
...
def list_lora_roots(models_root: str | None = None) -> list[str]:
    ...
    for key in ("sd15_loras", "sdxl_loras", "flux1_loras", "flux2_loras", "anima_loras", "wan22_loras", "zimage_loras"):
