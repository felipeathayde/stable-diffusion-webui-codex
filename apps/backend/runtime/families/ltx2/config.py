...
path resolution for `Lightricks/LTX-2` without inventing alternate repo layouts.
...
- `resolve_ltx2_vendor_paths` (function): Resolve fail-loud local vendor metadata paths for the LTX2 repo.
"""
