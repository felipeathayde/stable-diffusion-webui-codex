...
- 2026-03-08: WAN22 semantic capabilities expose recommendation hints as `recommended_samplers=('uni-pc', 'euler', 'euler a')` and `recommended_schedulers=('simple',)`, with defaults `default_sampler='uni-pc'` and `default_scheduler='simple'`.
