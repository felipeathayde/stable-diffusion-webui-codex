...
- 2026-02-16: WAN22 family handling is explicit by variant in `FAMILY_TO_ENGINE_KEY` (`WAN22_5B -> wan22_5b`, `WAN22_14B -> wan22_14b`, `WAN22_ANIMATE -> wan22_animate_14b`); `wan22_14b` remains experimental/opt-in via explicit engine registration.
