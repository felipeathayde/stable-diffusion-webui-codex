...
- `apps/backend/runtime/state_dict/keymap_qwen_text_encoder.py`: Qwen text-encoder key-style detector/remap (HF/wrapped layouts → canonical `model.*` backbone keys; optional aux heads accepted).
