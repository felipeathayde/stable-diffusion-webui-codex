...
Purpose: Runtime tools facade exposing heavyweight offline-style utilities (e.g. GGUF conversion).
Re-exports the public GGUF converter API used by `/api/tools/*` and CLI-like tooling.
