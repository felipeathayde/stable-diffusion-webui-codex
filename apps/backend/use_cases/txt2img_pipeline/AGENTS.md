...
- 2026-03-09: `_run_hires_pass(...)` now applies hires-prompt sampler/scheduler and width/height controls before explicit hires request overrides, and records the effective hires sampler/scheduler/steps/denoise/size payload on the processing object for final response metadata.
