...
class CodexGUILauncher(tk.Tk):
    ...
    def _build_tab_logging(self) -> ttk.Frame:
        ...
        # Log Level
        row = self._add_combo_row(frame, row, "Codex Log Level",
                                  ["DEBUG", "INFO", "WARNING", "ERROR", "CRITICAL"],
                                  self.env.get("CODEX_LOG_LEVEL", "DEBUG").upper(),
                                  "_var_log_level")
        ...
        # WAN log flags
        wan_log_flags = [
            ("WAN_LOG_INFO", "WAN Info Logs", "1"),
            ("WAN_LOG_WARN", "WAN Warning Logs", "1"),
            ("WAN_LOG_ERROR", "WAN Error Logs", "1"),
            ("WAN_LOG_DEBUG", "WAN Debug Logs", "0"),
        ]
    ...
    def _collect_settings(self) -> None:
        ...
        # Logging
        env["CODEX_LOG_LEVEL"] = self._var_log_level.get()
