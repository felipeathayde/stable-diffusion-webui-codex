...
- 2026-03-01: `payloads_video.ts` now emits no-stretch img2vid guide fields (`img2vid_image_scale`, `img2vid_crop_offset_x`, `img2vid_crop_offset_y`) with strict validation (`image_scale > 0` + offsets in `[0,1]`).
