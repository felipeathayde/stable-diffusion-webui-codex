...
- Model/sampler/scheduler dropdowns live em `ModelSelector.vue`, `SamplerSelector.vue` e `SchedulerSelector.vue`; views como `/flux` devem reutilizar esses componentes em vez de construir selects ad-hoc.
