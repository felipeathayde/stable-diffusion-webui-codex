...
- 2026-03-01: `InitialImageCard.vue` and `Img2ImgInpaintParamsCard.vue` now expose optional `zoomFrameGuide` pass-through config for `ImageZoomOverlay.vue`, allowing WAN init-image zoom previews to render no-stretch frame projection guides.
