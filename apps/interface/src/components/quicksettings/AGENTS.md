...
- `QuickSettingsWan.vue` — WAN22-specific quicksettings (mode + `LightX2V` toggle, high/low model dirs, metadata/text encoder/VAE selectors, guided gen entrypoint, precision, VRAM, attention backend, overrides).
