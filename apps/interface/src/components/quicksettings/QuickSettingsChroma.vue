...
Purpose: Chroma quicksettings selectors (model + assets).
Renders Chroma model, VAE, and T5 text encoder selectors for Chroma model tabs.

Symbols (top-level; keep in sync; no ghosts):
- `QuickSettingsChroma` (component): Chroma quicksettings row used by the main quicksettings bar.
...
<template>
  <!-- Chroma-specific quicksettings row -->
  ...
  <div v-if="showTextEncoder" class="quicksettings-group qs-group-text-encoder">
    <label class="label-muted">Text Encoder (T5)</label>
    <div class="qs-row">
      <div class="qs-pair">
