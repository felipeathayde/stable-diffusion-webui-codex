...
Purpose: FLUX.2 Klein quicksettings selectors.
Renders checkpoint/VAE selectors plus the truthful single Qwen3-4B text-encoder row for the current FLUX.2 Klein 4B / base-4B frontend slice.

Symbols (top-level; keep in sync; no ghosts):
- `QuickSettingsFlux2` (component): FLUX.2 quicksettings for checkpoint/VAE and the single Qwen3-4B text encoder.
