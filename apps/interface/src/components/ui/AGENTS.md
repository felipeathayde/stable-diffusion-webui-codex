...
- 2026-03-01: `ImageZoomOverlay.vue` now supports optional WAN frame-guide overlays (toggle + source/scaled/frame/policy metadata) using deterministic `cover + center-crop` projection math for init-image previews.
