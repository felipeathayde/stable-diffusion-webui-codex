...
- 2026-02-21: `WANTab.vue` now exposes WAN generation modes as `txt2vid|img2vid` only; vid2vid input cards/controls and vid2vid history apply branches were removed while legacy `mode='vid2vid'` history snapshots now downgrade to `txt2vid` on apply.
