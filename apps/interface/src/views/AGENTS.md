...
- 2025-12-22: `WANTab.vue` now uses sliders for core video params (width/height/frames/fps) and stage params (steps/CFG), and seed actions (🎲/↺) are embedded inside the seed input to match SDXL-style controls.
