...
- 2026-01-29: `ToolsTab.vue` GGUF converter can request CodexPack v1 packing (adds `codexpack_v1=true` to the request; Z-Image Base only; forces Q4_K + Comfy Layout).
