...
from apps.server.backend.runtime.text_processing.textual_inversion import create_embedding_from_data
    ...
    try:
        ...
        if ext in (".safetensors",):
            ...
            if hasattr(img, 'text') and 'sd-ti-embedding' in img.text:
                import base64, json
                from apps.server.backend.runtime.text_processing.textual_inversion import EmbeddingDecoder
