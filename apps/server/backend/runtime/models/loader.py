...
from apps.server.backend.runtime.models.state_dict import (
...
from apps.server.backend.engines.diffusion.sd20 import StableDiffusion2
from apps.server.backend.engines.diffusion.sdxl import StableDiffusionXL, StableDiffusionXLRefiner
from apps.server.backend.engines.diffusion.sd35 import StableDiffusion3
from apps.server.backend.engines.diffusion.flux import Flux
from apps.server.backend.engines.diffusion.chroma import Chroma
...
def load_huggingface_component(guess, component_name, lib_name, cls_name, repo_path, state_dict):
    ...
    if lib_name in ['transformers', 'diffusers']:
        ...
        if cls_name == 'T5EncoderModel':
            ...
            from apps.server.backend.runtime.nn.t5 import IntegratedT5
