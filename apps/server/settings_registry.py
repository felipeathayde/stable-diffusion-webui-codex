...
FIELDS: list[FieldDef] = [
    ...
    FieldDef(key='sd_model_checkpoint', label='(Managed by Forge)', type=SettingType.TEXT, section=SectionId.SD, default=None, min=None, max=None, step=None, choices=None, choices_source=None),
    ...
    FieldDef(key='CLIP_stop_at_last_layers', label='(Managed by Forge)', type=SettingType.NUMBER, section=SectionId.SD, default=1, min=None, max=None, step=None, choices=None, choices_source=None),
    ...
    FieldDef(key='sd_vae', label='(Managed by Forge)', type=SettingType.TEXT, section=SectionId.VAE, default='Automatic', min=None, max=None, step=None, choices=None, choices_source=None),
    ...
    FieldDef(key='forge_try_reproduce', label='Try to reproduce the results from external software', type=SettingType.RADIO, section=SectionId.COMPATIBILITY, default='None', min=None, max=None, step=None, choices=None, choices_source='lambda'),
