...
try:
    from modules_forge.config import removed_extensions as _removed_extensions
except Exception:
    _removed_extensions = []
...
def list_extensions():
    ...
    for dirname in [extensions_builtin_dir, extensions_dir]:
        ...
        for extension_dirname in sorted(os.listdir(dirname)):
            ...
            # Skip removed extensions entirely (not even listed in UI)
            if extension_dirname in _removed_extensions:
                continue
