...
def apply_single_hypernetwork(hypernetwork, context_k, context_v, layer=None):
    ...
    context_k = devices.cond_cast_core(hypernetwork_layers[0](devices.cond_cast_float(context_k)))
    context_v = devices.cond_cast_core(hypernetwork_layers[1](devices.cond_cast_float(context_v)))
    return context_k, context_v
