...
from apps.backend.interfaces.api.script_models import ScriptArg, ScriptInfo
...
class Script:
    ...
    api_info = None
    """Generated value of type apps.backend.interfaces.api.script_models.ScriptInfo with information about the script for API"""
...
class ScriptRunner:
    ...
    def create_script_ui_inner(self, script):
        ...
        for control in controls:
            ...
            arg_info = ScriptArg(label=control.label or "")
